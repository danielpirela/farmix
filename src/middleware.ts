...
export async function middleware(req: NextRequest) {
  ...
  const protectedRoutes: Record<string, string[]> = {
    ...
    '/dashboard/admin/animals/reports': [
      ROLES.admin,
      ROLES.owner,
      ROLES.foreman
    ],
    '/dashboard/admin/animals/health': [
      ROLES.admin,
      ROLES.owner,
      ROLES.foreman,
      ROLES.milker,
    ...
    '/dashboard/admin/suppliers/reports': [
      ROLES.admin,
      ROLES.owner,
      ROLES.foreman
    ],
    ...
    '/dashboard/admin/inventory/reports': [
      ROLES.admin,
      ROLES.owner,
      ROLES.foreman,
      ROLES.employee
    ...
    '/dashboard/employees/certificates': [
      ROLES.employee,
      ROLES.owner,
      ROLES.foreman,
      ROLES.milker,
